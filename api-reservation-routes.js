...
module.exports = function (app) {
  ...
  app.post("/api/reservation", function (req, res) {
    ...
    client.messages.create({
        body: 'Ocean Air Rentals - Succesful Rental Confirmation.' +" " + 'Beach: '+ req.body.reservationBeach + " " + 'Rental Item: ' + req.body.reservationItem + " " + 'Date ' + req.body.reservationDate,
